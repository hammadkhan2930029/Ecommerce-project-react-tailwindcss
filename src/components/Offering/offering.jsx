        ...
        <div className="flex justify-center flex-col items-center">
            <div className="flex flex-col md:flex-row justify-between items-center w-full px-5 md:px-10 py-5" style={{ padding: 10 }}>
                <div className="flex flex-col md:w-1/2 px-2 md:px-5" style={{ padding: 20 }}>
                    ...
                    <span className="text-black text-6xl font-bold leading-tight" style={{ paddingTop: 10, fontSize: screenWith == 430 && '32px', }}>Services Built Specifically For Your Business</span>
                </div>
                <div style={{ padding: 10, width: screenWith <= 480 ? '100%' : "8%" }} className="flex justify-between items-center space-x-3 mt-4 md:mt-0">
