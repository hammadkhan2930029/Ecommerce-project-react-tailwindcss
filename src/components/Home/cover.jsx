                ...
                <div className="container mx-auto px-4 sm:px-8 md:px-16" >
                    <div className="max-w-4xl">
                        <motion.span
                            ...
                            className="text-orange-400 text-sm sm:text-base md:text-lg font-semibold block mb-4">
                            Tech Management
                        </motion.span>
                        <motion.h1
                            className="text-white text-3xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6"
                            initial={{ y: -50, opacity: 0 }}
                            animate={{ y: 0, opacity: 1 }}
                            transition={{ duration: 2 }}>
